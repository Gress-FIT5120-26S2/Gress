...
export function AchievementQuestSection({ copy, daily, weekly, dailyRerollsRemaining, weeklyRerollsRemaining, rerollingAssignmentUid, onReroll, formatEndsAt }: Props) {
  ...
  return <View style={styles.card}>
    <View style={styles.header}><View><Text style={styles.eyebrow}>TODAY · THIS WEEK</Text><Text style={styles.title}>{copy.title}</Text></View><View style={styles.score}><Text style={styles.scoreValue}>{completed}/{all.length}</Text><Text style={styles.scoreLabel}>{copy.completed}</Text></View></View>
    <QuestGroup copy={copy} items={daily} label={copy.daily} onSelect={setSelected} />
