...
const zh = {
  ...
  fridge: {
    ...
    photoRecognition: {
      ...
      recognising: '正在观察食材…',
      errorTitle: '这次没有识别成功',
      errorDescription: '可以调整光线后重新拍摄，也可以直接进入手动填写。',
      unknownTitle: '还不能确认这是什么',
      unknownDescription: '模型没有找到足够可信的结果，已为你保留手动填写入口。',
      retry: '重新拍摄',
      reviewTitle: '识别完成',
      confidence: (percent: number) => `识别置信度 ${percent}%`,
      dragModel: '拖动查看 3D 食材',
      fieldsTitle: '将预填以下信息',
      name: '名称',
      freshness: '新鲜程度',
      unit: '单位',
      ...
      category: '种类',
      expiry: '预计过期时间',
      estimatedHint: '根据视觉新鲜度和常见保质期估算，进入表单后仍可修改。',
      retake: '重新拍摄',
      continue: '继续填写',
...
const en: Translation = {
  ...
  fridge: {
    ...
    photoRecognition: {
      ...
      cameraHint: 'Place one ingredient in the frame with even lighting',
      ...
      errorDescription: 'Adjust the lighting and try again, or continue with manual entry.',
      unknownTitle: 'We cannot confirm this ingredient yet',
      unknownDescription: 'The model did not find a confident match. Manual entry is still available.',
      retry: 'Retake photo',
      reviewTitle: 'Recognition complete',
      confidence: (percent: number) => `${percent}% recognition confidence`,
      dragModel: 'Drag to inspect the 3D ingredient',
      fieldsTitle: 'These details will be prefilled',
      name: 'Name',
      freshness: 'Freshness',
      unit: 'Unit',
      storage: 'Storage',
      ...
      estimatedHint: 'Estimated from visual freshness and common shelf life. Every field remains editable in the next step.',
      retake: 'Retake photo',
