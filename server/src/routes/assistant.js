      ...
      turns.push({
        ...
        response: {
          answer: {
            ...
            rejectedRequestTypes: Array.isArray(payload.rejectedRequestTypes) ? payload.rejectedRequestTypes : [],
            riskLevel: ['info', 'warning', 'danger'].includes(payload.riskLevel) ? payload.riskLevel : 'info',
            scopeDecision: ['in_scope', 'mixed', 'out_of_scope'].includes(payload.scopeDecision) ? payload.scopeDecision : 'in_scope',
          },
          conversationUid,
